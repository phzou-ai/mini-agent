...
def run_memory_command(argv: list[str]) -> None:
    parser = argparse.ArgumentParser(prog="vermay-agent memory")
...
def run_skills_command(argv: list[str]) -> None:
    parser = argparse.ArgumentParser(prog="vermay-agent skills")
    subparsers = parser.add_subparsers(dest="command", required=True)
...
def run_eval_command(argv: list[str]) -> None:
    parser = argparse.ArgumentParser(prog="vermay-agent eval")
    subparsers = parser.add_subparsers(dest="command", required=True)
...
def run_mcp_command(argv: list[str]) -> None:
    parser = argparse.ArgumentParser(prog="vermay-agent mcp")
    subparsers = parser.add_subparsers(dest="command", required=True)
